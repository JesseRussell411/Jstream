...
export function isAsyncIterable(item: any): item is AsyncIterable<any>;

export function isAsyncIterable(item: any): boolean {
...
export function isSet<T>(item: AwaitableIterable<T>): item is Set<T>;
